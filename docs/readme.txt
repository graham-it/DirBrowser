...
After downloading the program archive from the provided URLs, you need to
extract the files in the "bin" folder and copy them to the root folder of
the media where you want to use the program.
...
2) by launching the self-executable program "tdb64", which must be located
   in the same folder as Dir Browser, with the command:
   	LOAD"TDB64",8,1
